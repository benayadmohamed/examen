...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers(HttpMethod.POST, "/analyses").hasAuthority("EDIT_ANALYSE")
                .antMatchers(HttpMethod.PUT, "/analyses").hasAuthority("EDIT_ANALYSE")
                .antMatchers(HttpMethod.GET, "/analyses").hasAuthority("READ_ANALYSE")
                .antMatchers(HttpMethod.GET, "/analyses/{\\d+}").hasAuthority("READ_ANALYSE")
                .antMatchers(HttpMethod.DELETE, "/analyses/{\\d+}").hasAuthority("DELETE_ANALYSE")
